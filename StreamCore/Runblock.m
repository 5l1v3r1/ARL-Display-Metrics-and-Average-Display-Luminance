...
Screen('TextColor',Parameters.window, textColor);        
Screen(Parameters.window,'DrawText','Please Wait');
Screen(Parameters.window,'Flip');


    evalstring=sprintf('%s(Parameters,[],0,blocknum,modeflag,[],Block_Export,Trial_Export,FullUserdata.Demodata,FullUserdata)',blocktype{1}); %sets up the stimuli and initializes other parameters
    ...
    while(trial < Numtrials)
        ...
        evalstring=sprintf('%s(Parameters,Stimuli_sets,trial,blocknum,modeflag,[],Block_Export,Trial_Export,FullUserdata.Demodata,FullUserdata)',blocktype{1}); %sets up the stimuli and initializes other parameters
        ...
        modeflag = 'EndTrial';
        evalstring=sprintf('%s(Parameters,tempstim,trial,blocknum,modeflag,Events,Block_Export,Trial_Export,FullUserdata.Demodata,FullUserdata)',blocktype{1}); %sets up the stimuli and initializes other parameters
    ...
    modeflag = 'EndBlock';
    evalstring=sprintf('%s(Parameters,Stimuli_sets,0,blocknum,modeflag,[],Block_Export,Trial_Export,FullUserdata.Demodata,FullUserdata)',blocktype{1}); %sets up the stimuli and initializes other parameters
    [x2 Parameters x5  Block_Export Trial_Export ]= eval(evalstring);
    FullUserdata.Blocks(blocknum).Block_Export = Block_Export;
