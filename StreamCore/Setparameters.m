...
Parameters.backgroundcolor = [0 0 0];   %what color is the background screen in RGB (0-255)
...
Parameters.ScreenResolutionX = 1680;
Parameters.ScreenResolutionY = 1050;

%%%%%%%%%%%%%%%%%%%%%%%%
%%%% use the mouse?
Parameters.mouse.enabled = 1;
Parameters.mouse.datastore = 0;
Parameters.mouse.cursorsize = 0;
Parameters.mouse.cursorcolor = [0,255,0];
...
Parameters.saveevery = 8;   %save a backup file after every X trials
