function [Events evnum] = newevent_mouse(Events,time,responsestruct)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Stream
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%newevent_mouse(Events,time,responsestruct)
...
%
%newevent_mouse is called by your block files.
