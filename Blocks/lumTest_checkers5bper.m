...
elseif strcmp(Modeflag,'InitializeTrial');
    ...
    for checkersCon = 1%:7
        ...
        for blackWhite =1:2
            for size=1:3
                hOffset = 0; hAdj = round(1920/25);
                for rowChunk =1:108
                    adj = (rowChunk-1)*10;

                    Events = newevent_show_stimulus(Events,1,1,rem(1+hOffset,192*dim),0+adj,startTime,'screenshot_no','clear_no');
                    Events = newevent_show_stimulus(Events,1,1,rem(round(192*1/10*dim+hOffset),192*dim),0+adj,startTime,'screenshot_no','clear_no');
                    Events = newevent_show_stimulus(Events,1,1,rem(round(192*2/10*dim+hOffset),192*dim),0+adj,startTime,'screenshot_no','clear_no');
                    Events = newevent_show_stimulus(Events,1,1,rem(round(192*3/10*dim+hOffset),192*dim),0+adj,startTime,'screenshot_no','clear_no');
                    Events = newevent_show_stimulus(Events,1,1,rem(round(192*4/10*dim+hOffset),192*dim),0+adj,startTime,'screenshot_no','clear_no');
                    Events = newevent_show_stimulus(Events,1,1,rem(round(192*5/10*dim+hOffset),192*dim),0+adj,startTime,'screenshot_no','clear_no');
                    Events = newevent_show_stimulus(Events,1,1,rem(round(192*6/10*dim+hOffset),192*dim),0+adj,startTime,'screenshot_no','clear_no');
                    Events = newevent_show_stimulus(Events,1,1,rem(round(192*7/10*dim+hOffset),192*dim),0+adj,startTime,'screenshot_no','clear_no');
                    Events = newevent_show_stimulus(Events,1,1,rem(round(192*8/10*dim+hOffset),192*dim),0+adj,startTime,'screenshot_no','clear_no');
                    Events = newevent_show_stimulus(Events,1,1,rem(round(192*9/10*dim+hOffset),192*dim),0+adj,startTime,'screenshot_no','clear_no');
