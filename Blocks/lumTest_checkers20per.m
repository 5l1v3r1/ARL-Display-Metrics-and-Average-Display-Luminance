        ...
        for blackWhite =1:2
            for size=1:3
                for rowChunk =1:96
                    ...
                    for i = 1:37
                    Events = newevent_show_stimulus(Events,1,1,round(192*(i/38))*dim,0+adj,startTime,'screenshot_no','clear_no');
                    end
                    %2
                    Events = newevent_show_stimulus(Events,5,1,1,10+adj,startTime,'screenshot_no','clear_no');
                    for i = 1:2:75
                    Events = newevent_show_stimulus(Events,1,1,round(192*(i/76))*dim,10+adj,startTime,'screenshot_no','clear_no');
                    end
                end
                if blackWhite==1
